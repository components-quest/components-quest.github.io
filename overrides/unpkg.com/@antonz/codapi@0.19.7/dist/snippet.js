...
`;
    var G = {
        ...
        [d.html]: n=>{
            ...
            return Array.from(t.body.childNodes).forEach(s=>e.appendChild(s)),
            e
        }
        ,
        [d.iframe]: n=>{
      ...
      , C = class extends HTMLElement {
        ...
        connectedCallback() {
            this.ready || (this.appendChild(M.content.cloneNode(!0)),
...
${t.stack}` : "");
    ...
    var p = {
      ...
      , E = class extends EventTarget {
        ...
        handleExecute(t) {
            !t.ctrlKey && !t.metaKey || t.key !== "Enter" && t.key !== "NumpadEnter" || (t.preventDefault(),
            this.executeFunc())
        }
        onPaste(t) {
            t.preventDefault();
...
`).replace(/[\u00A0]/g, " ")
    ...
    var S = class extends HTMLElement {
        connectedCallback() {
            this.ready || (a.settings.url = this.getAttribute("url"),
            this.ready = !0)
        }
    ...
    ;
    window.customElements.get("codapi-settings") || customElements.define("codapi-settings", S);
...
`;
    var v = class extends HTMLElement {
        ...
        init() {
            ...
            this.executor = this.hasAttribute("sandbox") ? new b({
        ...
        listen() {
            ...
            this.editor == p.basic && (this._toolbar.editable = !0,
        ...
        async execute(t=void 0) {
            if (this.executor) {
                ...
                try {
                    ...
                    this._fallback ? (this._toolbar.showStatus(yt.fallback),
                    this._output.showResult(this._fallback)) : (this._toolbar.showFinished({}),
    ...
    ;
    L(v, "observedAttributes", ["sandbox", "engine", "command", "template", "files"]);
    function vt(n) {
        let t = new Set
          , e = []
          , s = (o,r)=>{
            ...
            t.has(r) || (t.add(r),
            o.dependsOn && o.dependsOn.split(" ").forEach(u=>{
